...
_tool("filesystem.read","Read files from an approved workspace.","files",RiskLevel.LOW,ReadWriteMode.READ_ONLY,NetworkRequirement.NONE,AuthenticationRequirement.NONE,ApprovalRequirement.NONE,SandboxRequirement.REQUIRED,AuditRequirement.REQUIRED,Capability.READ_FILE,safe_autonomous=True,input_schema=_FILES_INPUT),
