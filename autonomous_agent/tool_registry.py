...
_tool("workspace.shell","Run a bounded read-only workspace shell command.","workspace",RiskLevel.LOW,ReadWriteMode.READ_ONLY,NetworkRequirement.NONE,AuthenticationRequirement.NONE,ApprovalRequirement.NONE,SandboxRequirement.REQUIRED,AuditRequirement.REQUIRED,Capability.WORKSPACE_SHELL,safe_autonomous=True,input_schema={"type":"object","properties":{"argv":{"type":"array"}},"additionalProperties":False}),
