...
class Capability(str,Enum):
    INSPECT="inspect";TEST="test";LINT="lint";METRICS="metrics";READ_FILE="read_file";BENCHMARK="benchmark";WEB_RESEARCH="web_research";FILES_WORKSPACE="files_workspace";NETWORK="network";SECRETS="secrets";BILLING="billing";SOURCE_WRITE="source_write";MERGE="merge";DEPLOY="deploy";DESTRUCTIVE="destructive"
SAFE_CAPABILITIES=frozenset({Capability.INSPECT,Capability.TEST,Capability.LINT,Capability.METRICS,Capability.READ_FILE,Capability.BENCHMARK,Capability.WEB_RESEARCH,Capability.FILES_WORKSPACE})
