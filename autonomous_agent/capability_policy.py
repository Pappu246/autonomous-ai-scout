...
class Capability(str,Enum):
    INSPECT="inspect";TEST="test";LINT="lint";METRICS="metrics";READ_FILE="read_file";BENCHMARK="benchmark";WEB_RESEARCH="web_research";FILES_WORKSPACE="files_workspace";WORKSPACE_SHELL="workspace_shell";EMAIL="email";CALENDAR="calendar";BROWSER="browser";REST_API="rest_api";NETWORK="network";SECRETS="secrets";BILLING="billing";SOURCE_WRITE="source_write";MERGE="merge";DEPLOY="deploy";DESTRUCTIVE="destructive"
SAFE_CAPABILITIES=frozenset({Capability.INSPECT,Capability.TEST,Capability.LINT,Capability.METRICS,Capability.READ_FILE,Capability.BENCHMARK,Capability.WEB_RESEARCH,Capability.FILES_WORKSPACE,Capability.WORKSPACE_SHELL,Capability.EMAIL,Capability.CALENDAR,Capability.BROWSER,Capability.REST_API})
