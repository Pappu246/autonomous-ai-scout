...
TOOL_SANDBOX_BINDINGS: Mapping[str, tuple[str, str | None, str | None]] = {
    ...
    "browser.session.open": ("browser", "browser", "session_open"),
    "browser.navigate": ("browser", "browser", "navigate"),
    "browser.back": ("browser", "browser", "back"),
    "browser.forward": ("browser", "browser", "forward"),
    "browser.reload": ("browser", "browser", "reload"),
    "browser.page.observe": ("browser", "browser", "page_observe"),
    "browser.element.find": ("browser", "browser", "element_find"),
    "browser.element.click": ("browser", "browser", "element_click"),
    "browser.element.type": ("browser", "browser", "element_type"),
    "browser.element.select": ("browser", "browser", "element_select"),
    "browser.download.start": ("browser", "browser", "download_start"),
    "browser.file.extract": ("browser", "browser", "file_extract"),
    ...
    "documents.inspect": ("documents", "documents", "inspect"),
    "documents.extract.text": ("documents", "documents", "extract_text"),
    "documents.extract.tables": ("documents", "documents", "extract_tables"),
    "documents.page.read": ("documents", "documents", "read_page"),
    "documents.transform": ("documents", "documents", "transform"),
    "application.list": ("application", "application", "list_applications"),
    "application.inspect": ("application", "application", "get_application"),
    "application.observe": ("application", "application", "observe"),
    "application.command.execute": ("application", "application", "execute_command"),
