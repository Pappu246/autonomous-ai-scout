...
def test_sandbox_has_explicit_safe_operation_allowlist():
    assert SAFE_OPERATIONS == {"inspect", "test", "lint", "metrics", "read_file", "benchmark", "web_research", "filesystem_workspace", "workspace_shell", "gmail", "calendar", "browser", "computer", "documents", "application"}
